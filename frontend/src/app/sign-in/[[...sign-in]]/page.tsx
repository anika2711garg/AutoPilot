    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="z-10 w-full flex justify-center">
        <div className="w-full max-w-md rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl shadow-2xl shadow-black/20">
          ...
          <h1 className="mt-3 text-2xl font-semibold tracking-tight text-white">Sign in disabled for local mock mode</h1>
          <p className="mt-3 text-sm leading-7 text-white/60">
            You can still explore the app now. Replace the placeholder env values later to enable Clerk authentication.
          </p>
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            ...
            <Link href="/sign-up" className="inline-flex h-11 items-center justify-center rounded-full border border-white/10 bg-white/5 text-sm font-medium text-white transition hover:bg-white/10">
              See signup
            </Link>
          </div>
        </div>
